...
void CRenderTarget::phase_zoom(bool Distort)
{
    u32 Offset = 0;
    Fvector2 p0, p1;
    ...
    // Draw COLOR
    RCache.set_Element(s_zoom->E[Distort ? 1 : 0]);
    ...
    {
        RCache.set_Element(s_zoom_msaa[0]->E[Distort ? 1 : 0]);
    }

    RCache.set_c("zoom_params", envdesc.test_scope_shader, envdesc.test_scope_shader_enabler, 0, 0);

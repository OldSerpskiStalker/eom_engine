...
HRESULT __stdcall xrIDirect3DVertexBuffer9::GetPrivateData(REFGUID refguid, void* pData, DWORD* pSizeOfData)
{
    APIDEBUG("xrIDirect3DVertexBuffer9::GetPrivateData");
    return HRESULT_Proc(S_OK);
};
HRESULT __stdcall xrIDirect3DVertexBuffer9::FreePrivateData(REFGUID refguid)
{
    APIDEBUG("xrIDirect3DVertexBuffer9::FreePrivateData");
    return HRESULT_Proc(S_OK);
};
DWORD __stdcall xrIDirect3DVertexBuffer9::SetPriority(DWORD PriorityNew)
{
    APIDEBUG("xrIDirect3DVertexBuffer9::SetPriority");
    DWORD old = Priority;
    Priority = PriorityNew;
    return DWORD_Proc(old);
};
DWORD __stdcall xrIDirect3DVertexBuffer9::GetPriority()
{
    APIDEBUG("xrIDirect3DVertexBuffer9::GetPriority");
    return DWORD_Proc(Priority);
};
void __stdcall xrIDirect3DVertexBuffer9::PreLoad()
{
    APIDEBUG("xrIDirect3DVertexBuffer9::PreLoad");
    return VOID_proc();
};
D3DRESOURCETYPE __stdcall xrIDirect3DVertexBuffer9::GetType()
{
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::Unlock()
{
    APIDEBUG("xrIDirect3DVertexBuffer9::Unlock");
    return HRESULT_Proc(S_OK);
};
HRESULT __stdcall xrIDirect3DVertexBuffer9::GetDesc(D3DVERTEXBUFFER_DESC* pDesc)
{
    APIDEBUG("xrIDirect3DVertexBuffer9::GetDesc");
    return HRESULT_Proc(S_OK);
};

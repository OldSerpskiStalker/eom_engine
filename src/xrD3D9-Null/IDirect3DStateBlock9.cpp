...
xrIDirect3DStateBlock9::xrIDirect3DStateBlock9(IDirect3DDevice9* pIDirect3DDevice9) : m_refCount(0)
{
...
HRESULT __stdcall xrIDirect3DStateBlock9::Capture()
{
    APIDEBUG("xrIDirect3DStateBlock9::Capture");
    return HRESULT_Proc(S_OK);
};
HRESULT __stdcall xrIDirect3DStateBlock9::Apply()
{
    APIDEBUG("xrIDirect3DStateBlock9::Apply");
    return HRESULT_Proc(S_OK);
};

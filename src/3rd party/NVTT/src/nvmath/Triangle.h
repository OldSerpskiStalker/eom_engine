...
NVMATH_API bool rayTest_Moller(
    const Triangle& t, Vector3::Arg orig, Vector3::Arg dir, float* out_t, float* out_u, float* out_v);
...
inline bool overlap(const Box& b, const Triangle& t) { return overlap(t, b); }

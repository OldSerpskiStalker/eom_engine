...
float Filter::sampleDelta(float x, float scale) const { return evaluate((x + 0.5f) * scale); }
...
float SincFilter::evaluate(float x) const { return sincf(PI * x); }
...
/// Ctor.
Kernel2::Kernel2(uint ws) : m_windowSize(ws) { m_data = new float[m_windowSize * m_windowSize]; }
...
void Kernel2::initSobel()
{
    ...
    {
        float elements[] = {-1, -2, 0, 2, 1, -2, -3, 0, 3, 2, -3, -4, 0, 4, 3, -2, -3, 0, 3, 2, -1, -2, 0, 2, 1};
    ...
    {
        float elements[] = {-1, -2, -3, 0, 3, 2, 1, -2, -3, -4, 0, 4, 3, 2, -3, -4, -5, 0, 5, 4, 3, -4, -5, -6, 0, 6, 5,
            4, -3, -4, -5, 0, 5, 4, 3, -2, -3, -4, 0, 4, 3, 2, -1, -2, -3, 0, 3, 2, 1};
    ...
    {
        float elements[] = {-1, -2, -3, -4, 0, 4, 3, 2, 1, -2, -3, -4, -5, 0, 5, 4, 3, 2, -3, -4, -5, -6, 0, 6, 5, 4, 3,
            -4, -5, -6, -7, 0, 7, 6, 5, 4, -5, -6, -7, -8, 0, 8, 7, 6, 5, -4, -5, -6, -7, 0, 7, 6, 5, 4, -3, -4, -5, -6,
            0, 6, 5, 4, 3, -2, -3, -4, -5, 0, 5, 4, 3, 2, -1, -2, -3, -4, 0, 4, 3, 2, 1};
...
void Kernel2::initPrewitt()
{
    ...
    {
        // @@ Is this correct?
        float elements[] = {-2, -1, 0, 1, 2, -2, -1, 0, 1, 2, -2, -1, 0, 1, 2, -2, -1, 0, 1, 2, -2, -1, 0, 1, 2};
...
void Kernel2::initBlendedSobel(const Vector4& scale)
{
    ...
    {
        const float elements[] = {-1, -2, -3, -4, 0, 4, 3, 2, 1, -2, -3, -4, -5, 0, 5, 4, 3, 2, -3, -4, -5, -6, 0, 6, 5,
            4, 3, -4, -5, -6, -7, 0, 7, 6, 5, 4, -5, -6, -7, -8, 0, 8, 7, 6, 5, -4, -5, -6, -7, 0, 7, 6, 5, 4, -3, -4,
            -5, -6, 0, 6, 5, 4, 3, -2, -3, -4, -5, 0, 5, 4, 3, 2, -1, -2, -3, -4, 0, 4, 3, 2, 1};
    ...
    {
        const float elements[] = {-1, -2, 0, 2, 1, -2, -3, 0, 3, 2, -3, -4, 0, 4, 3, -2, -3, 0, 3, 2, -1, -2, 0, 2, 1};
...
PolyphaseKernel::~PolyphaseKernel() { delete[] m_data; }

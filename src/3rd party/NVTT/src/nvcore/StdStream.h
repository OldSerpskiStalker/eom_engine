...
public:
    ...
    virtual bool isError() const { return m_mem == NULL || m_ptr > m_mem + m_size || m_ptr < m_mem; }
...
public:
    ...
    /// Ctor.
    ProtectedStream(Stream* s, bool autodelete = true) : m_s(s), m_autodelete(autodelete) { nvDebugCheck(m_s != NULL); }

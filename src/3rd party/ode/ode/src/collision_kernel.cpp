...
int dxGeom::AABBTest(dxGeom* o, dReal aabb[6]) { return 1; }
...
dxGeom* dGeomGetBodyNext(dxGeom* geom) { return geom->body_next; }
...
void dxUserGeom::computeAABB() { user_classes[type - dFirstUserClass].aabb(this, aabb); }

...
void dMassSetParameters(dMass* m, dReal themass, dReal cgx, dReal cgy, dReal cgz, dReal I11, dReal I22, dReal I33,
...
void dMassSetCappedCylinderTotal(dMass* m, dReal total_mass, int direction, dReal a, dReal b)
{

...
static ALCRouterEnum alcEnums[] = {
    // Types
    {"ALC_INVALID", ALC_INVALID}, {"ALC_FALSE", ALC_FALSE}, {"ALC_TRUE", ALC_TRUE},
    ...
    {"ALC_DEFAULT_DEVICE_SPECIFIER", ALC_DEFAULT_DEVICE_SPECIFIER}, {"ALC_DEVICE_SPECIFIER", ALC_DEVICE_SPECIFIER},
    {"ALC_EXTENSIONS", ALC_EXTENSIONS}, {"ALC_FREQUENCY", ALC_FREQUENCY}, {"ALC_REFRESH", ALC_REFRESH},
    {"ALC_SYNC", ALC_SYNC}, {"ALC_MONO_SOURCES", ALC_MONO_SOURCES}, {"ALC_STEREO_SOURCES", ALC_STEREO_SOURCES},
...
//
static ALCfunction alcFunctions[] = {{"alcCreateContext", (ALvoid*)alcCreateContext},
    {"alcMakeContextCurrent", (ALvoid*)alcMakeContextCurrent}, {"alcProcessContext", (ALvoid*)alcProcessContext},
    {"alcSuspendContext", (ALvoid*)alcSuspendContext}, {"alcDestroyContext", (ALvoid*)alcDestroyContext},
    {"alcGetCurrentContext", (ALvoid*)alcGetCurrentContext}, {"alcGetContextsDevice", (ALvoid*)alcGetContextsDevice},
    {"alcOpenDevice", (ALvoid*)alcOpenDevice}, {"alcCloseDevice", (ALvoid*)alcCloseDevice},
    {"alcGetError", (ALvoid*)alcGetError}, {"alcIsExtensionPresent", (ALvoid*)alcIsExtensionPresent},
    {"alcGetProcAddress", (ALvoid*)alcGetProcAddress}, {"alcGetEnumValue", (ALvoid*)alcGetEnumValue},
    {"alcGetString", (ALvoid*)alcGetString}, {"alcGetIntegerv", (ALvoid*)alcGetIntegerv},
    {"alcCaptureOpenDevice", (ALvoid*)alcCaptureOpenDevice}, {"alcCaptureCloseDevice", (ALvoid*)alcCaptureCloseDevice},
    {"alcCaptureStart", (ALvoid*)alcCaptureStart}, {"alcCaptureStop", (ALvoid*)alcCaptureStop},
    {"alcCaptureSamples", (ALvoid*)alcCaptureSamples}, {0, (ALvoid*)0}};

//
// Our extensions.
//
static ALCextension alcExtensions[] = {"ALC_ENUMERATION_EXT", 0};
...
//*****************************************************************************
BOOL GetLoadedModuleDirectory(
    LPCTSTR moduleName, LPTSTR directoryContainingModule, DWORD directoryContainingModuleLength)
{
    ...
    numChars = GetModuleFileName(module, directoryContainingModule, directoryContainingModuleLength);
    if (numChars == 0)
        return FALSE;
    ...
    { // don't re-build lists if it's already been done once...
        ...
        for (i = 0; i < numDirs; i++)
        {
            ...
            if (searchHandle != INVALID_HANDLE_VALUE)
            {
                ...
                {
                    //
                    // if this is an OpenAL32.dll, skip it -- it's probably a router and shouldn't be enumerated
                    // regardless
                    //
                    strcpy_s(searchName, dir[i]);
                    ...
                    if (strstr(cmpName, "OPENAL32.DLL") == 0)
                    {
                        ...
                        if (skipSearch == false)
                        {
                            ...
                            if (dll)
                            {
                                ...
                                alcMakeContextCurrentFxn =
                                    (ALCAPI_MAKE_CONTEXT_CURRENT)GetProcAddress(dll, "alcMakeContextCurrent");
                                ...
                                alcIsExtensionPresentFxn =
                                    (ALCAPI_IS_EXTENSION_PRESENT)GetProcAddress(dll, "alcIsExtensionPresent");

                                if ((alcOpenDeviceFxn != 0) && (alcCreateContextFxn != 0) &&
                                    (alcMakeContextCurrentFxn != 0) && (alcGetStringFxn != 0) &&
                                    (alcDestroyContextFxn != 0) && (alcCloseDeviceFxn != 0) &&
                                        ...
                                        if ((specifier) && strlen(specifier))
                                        {
                                            do
                                            {
                                                ...
                                                { // make sure we're not creating a duplicate device
                                                    strcpy_s((char*)list, list_end - list, specifier);
...
ALboolean FillOutAlcFunctions(ALCdevice* device)
{
    ...
    // handle legacy issue with old Creative DLLs which may not have alcGetProcAddress, alcIsExtensionPresent,
    // alcGetEnumValue
    ...
    alcFxns = (alcApi->alcCreateContext && alcApi->alcMakeContextCurrent && alcApi->alcProcessContext &&
        alcApi->alcSuspendContext && alcApi->alcDestroyContext && alcApi->alcGetCurrentContext &&
        alcApi->alcGetContextsDevice && alcApi->alcOpenDevice && alcApi->alcCloseDevice && alcApi->alcGetError &&
        alcApi->alcIsExtensionPresent && alcApi->alcGetProcAddress && alcApi->alcGetEnumValue && alcApi->alcGetString &&
...
ALboolean FillOutAlFunctions(ALCcontext* context)
{
    ...
    alApi->alIsExtensionPresent =
        (ALAPI_IS_EXTENSION_PRESENT)GetProcAddress(context->Device->Dll, "alIsExtensionPresent");
    ...
    alApi->alSourceQueueBuffers =
        (ALAPI_SOURCE_QUEUE_BUFFERS)GetProcAddress(context->Device->Dll, "alSourceQueueBuffers");
    alApi->alSourceUnqueueBuffers =
        (ALAPI_SOURCE_UNQUEUE_BUFFERS)GetProcAddress(context->Device->Dll, "alSourceUnqueueBuffers");
    ...
    alFxns = (alApi->alEnable && alApi->alDisable && alApi->alIsEnabled &&

        alApi->alGetString && alApi->alGetBooleanv && alApi->alGetIntegerv && alApi->alGetFloatv &&
        alApi->alGetDoublev && alApi->alGetBoolean && alApi->alGetInteger && alApi->alGetFloat && alApi->alGetDouble &&

        alApi->alGetError &&

        alApi->alIsExtensionPresent && alApi->alGetProcAddress && alApi->alGetEnumValue &&

        alApi->alListenerf && alApi->alListener3f && alApi->alListenerfv && alApi->alListeneri &&
        alApi->alGetListenerf && alApi->alGetListener3f && alApi->alGetListenerfv && alApi->alGetListeneri &&

        alApi->alGenSources && alApi->alDeleteSources && alApi->alIsSource && alApi->alSourcef && alApi->alSource3f &&
        alApi->alSourcefv && alApi->alSourcei && alApi->alGetSourcef && alApi->alGetSource3f && alApi->alGetSourcefv &&
        alApi->alGetSourcei && alApi->alSourcePlayv && alApi->alSourceStopv && alApi->alSourceRewindv &&
        alApi->alSourcePausev && alApi->alSourcePlay && alApi->alSourceStop && alApi->alSourceRewind &&
        alApi->alSourcePause &&

        alApi->alSourceQueueBuffers && alApi->alSourceUnqueueBuffers &&

        alApi->alGenBuffers && alApi->alDeleteBuffers && alApi->alIsBuffer && alApi->alBufferData &&
        alApi->alGetBufferf && alApi->alGetBufferi &&

        alApi->alDopplerFactor && alApi->alDopplerVelocity && alApi->alDistanceModel);
...
//*****************************************************************************
//
HINSTANCE FindDllWithMatchingSpecifier(TCHAR* dllSearchPattern, char* specifier, bool partialName = false,
    char* actualName = NULL, bool captureDevice = false)
{
    WIN32_FIND_DATA findData;
    HANDLE searchHandle = INVALID_HANDLE_VALUE;
    TCHAR searchName[MAX_PATH + 1];
                                                ...
                                                do
                                                {
                                                    if (deviceSpecifier != NULL)
                                                    {
                                                        if ((partialName == false) ||
                                                            (strstr(deviceSpecifier, "Generic") != 0))
                                                        {
                                                            found = strncmp(deviceSpecifier, specifier, 31) == 0;
                                                            // note -- specifier may be a non-truncated version of
                                                            // deviceSpecifier, which is why strncmp is being used
                                                        }
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                strcpy_s(
                                                                    actualName, MAX_DEVICE_STRINGS, deviceSpecifier);
                                                            }
                                                        }
                                                    }
                                                    else
                                                    ...
                                                    (deviceSpecifier[0] != '\0' /*strlen(deviceSpecifier) > 0*/));
                                            }
                                        }
                                        else
                                        {
                                            ...
                                            if (device != NULL)
                                            {
                                                ...
                                                {
                                                    deviceSpecifier =
                                                        (char*)alcGetStringFxn(device, ALC_DEFAULT_DEVICE_SPECIFIER);
                                                    if (deviceSpecifier != NULL)
                                                    {
                                                        if ((partialName == false) ||
                                                            (strstr(deviceSpecifier, "Generic") != 0))
                                                        {
                                                            found = strncmp(deviceSpecifier, specifier, 31) == 0;
                                                            // note -- specifier may be a non-truncated version of
                                                            // deviceSpecifier; hence the use of strncmp
                                                        }
                                                        else
                                                        {
                                                            found = strstr(deviceSpecifier, specifier) != 0;
...
//*****************************************************************************
//
ALCAPI ALCcontext* ALCAPIENTRY alcGetCurrentContext(ALvoid) { return (ALCcontext*)alCurrentContext; }
...
ALCAPI ALboolean ALCAPIENTRY alcMakeContextCurrent(ALCcontext* context)
{
    ...
    {
        if ((alCurrentContext) && (alCurrentContext->Device) &&
            (alCurrentContext->Device->AlcApi.alcMakeContextCurrent))
        {
...
void getDefaultPlaybackDeviceNames(char* longName, char* shortName, unsigned int len)
{
    ...
    CoInitialize(NULL);
    hr = CoCreateInstance(
        __uuidof(MMDeviceEnumerator), NULL, CLSCTX_INPROC_SERVER, __uuidof(IMMDeviceEnumerator), (void**)&pEnumerator);
    if SUCCEEDED (hr)
    {
...
ALCAPI const ALCchar* ALCAPIENTRY alcGetString(ALCdevice* device, ALenum param)
{
    ...
    case ALC_DEFAULT_DEVICE_SPECIFIER: {
        while (TRUE)
        {
            ...
            if (strlen(longDevice))
            { // test long device name first
            ...
            if (strlen(mixerDevice))
            { // test short device name (mixerDevice) next, with partial matches potentially...
    ...
    case ALC_CAPTURE_DEFAULT_DEVICE_SPECIFIER: {
        while (TRUE)
        {
            ...
            if (strlen(mixerDevice))
            { // look for short device (mixerDevice)
                if (strstr(mixerDevice, T2A("Audigy")) != NULL)
                {
                    acceptPartial = true;
                    strcpy_s(mixerDevice, T2A("Audigy"));
    ...
    default: LastError = ALC_INVALID_ENUM; break;
    }
...
ALCAPI ALCdevice* ALCAPIENTRY alcCaptureOpenDevice(
    const ALCchar* deviceName, ALCuint frequency, ALCenum format, ALCsizei buffersize)
{
    char newDeviceName[256];
    ...
    if (!g_CaptureDevice)
    {
        ...
        if (g_CaptureDevice)
        {
            ...
            g_CaptureDevice->Dll =
                FindDllWithMatchingSpecifier(_T("*oal.dll"), (char*)newDeviceName, false, NULL, true);
                ...
                if (FillOutAlcFunctions(g_CaptureDevice))
                {
                    if (g_CaptureDevice->AlcApi.alcCaptureOpenDevice)
                    {
                        g_CaptureDevice->CaptureDevice =
                            g_CaptureDevice->AlcApi.alcCaptureOpenDevice(newDeviceName, frequency, format, buffersize);

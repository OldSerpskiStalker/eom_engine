...
//////////////////////////////////////////////////////////
long CxMemFile::Scanf(const char* format, void* output) { return 0; }
//////////////////////////////////////////////////////////
bool CxMemFile::Alloc(DWORD dwNewLen)
{
    if (dwNewLen > (DWORD)m_Edge)
    {
        ...
        // allocate new buffer
        if (m_pBuffer == NULL)
            m_pBuffer = (BYTE*)cxalloc(dwNewBufferSize); // malloc(dwNewBufferSize);
        else
            m_pBuffer = (BYTE*)cxrealloc(m_pBuffer, dwNewBufferSize); // realloc(m_pBuffer, dwNewBufferSize);

...
{
    module(L)[class_<Fvector>("vector")
                  ...
                  //float))(&Fvector::random_dir), return_reference_to(_1)) 			.def("random_point",				(Fvector
                  //& (Fvector::*)(const Fvector &))(&Fvector::random_point),
                  //return_reference_to(_1)) 			.def("random_point",				(Fvector &
                  ...
                  //			.def("from_bary",					(Fvector & (Fvector::*)(const Fvector &, const
                  //Fvector &, const Fvector &, float, float, float))(&Fvector::from_bary),	return_reference_to(_1))
                  //			.def("from_bary",					(Fvector & (Fvector::*)(const Fvector &, const
                  //Fvector &, const Fvector &, const Fvector &))(&Fvector::from_bary),		return_reference_to(_1))

...
void CScriptIniFile::save_at_end(bool b) { inherited::save_at_end(b); }
...
void CScriptIniFile::set_override_names(bool b) { inherited::set_override_names(b); }

void CScriptIniFile::set_readonly(bool b) { inherited::m_flags.set(eReadOnly, b); }

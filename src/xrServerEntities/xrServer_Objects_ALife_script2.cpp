...
{
    module(
        L)[luabind_class_dynamic_alife2(CSE_ALifeCar, "cse_alife_car", CSE_ALifeDynamicObjectVisual, CSE_PHSkeleton)];
}
...
{
    module(L)[luabind_class_abstract2(CSE_ALifeObjectClimable, "cse_alife_object_climable", CSE_Shape, CSE_Abstract)];
}
...
{
    module(
        L)[luabind_class_dynamic_alife1(CSE_ALifeTeamBaseZone, "cse_alife_team_base_zone", CSE_ALifeSpaceRestrictor)];
}

...
#define script_type_list save_type_list(CSE_ALifeInventoryItem)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(
        CSE_ALifeItem, CSE_ALifeDynamicObjectVisual, CSE_ALifeInventoryItem) bool m_physics_disabled;
...
#define script_type_list save_type_list(CSE_ALifeItemCustomOutfit)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemHelmet, CSE_ALifeItem) CSE_ALifeItemHelmet(LPCSTR caSection);

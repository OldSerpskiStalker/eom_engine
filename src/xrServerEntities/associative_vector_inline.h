...
TEMPLATE_SPECIALIZATION
IC bool _associative_vector::operator<=(const self_type& right) const { return !(right < left); }

TEMPLATE_SPECIALIZATION
IC bool _associative_vector::operator>(const self_type& right) const { return (right < left); }

TEMPLATE_SPECIALIZATION
IC bool _associative_vector::operator>=(const self_type& right) const { return !(left < right); }

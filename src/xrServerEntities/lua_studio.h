...
class lua_studio_engine : public cs::lua_studio::engine, private boost::noncopyable
{
public:
...
public:
    ...
    virtual bool CS_LUA_STUDIO_BACKEND_CALL type_to_string(
        char* buffer, unsigned int size, lua_State* state, int index, bool& use_in_description);
    virtual bool CS_LUA_STUDIO_BACKEND_CALL value_to_string(cs::lua_studio::backend& backend, char* buffer,
        unsigned int size, lua_State* state, int index, cs::lua_studio::icon_type& icon_type, bool full_description);
    virtual bool CS_LUA_STUDIO_BACKEND_CALL expand_value(
        cs::lua_studio::backend& backend, cs::lua_studio::value_to_expand& value, lua_State* state);
    virtual bool CS_LUA_STUDIO_BACKEND_CALL push_value(
        lua_State* state, char const* id, cs::lua_studio::icon_type icon_type);
...
private:
    ...
    void expand_class(cs::lua_studio::backend& backend, cs::lua_studio::value_to_expand& value, lua_State* const state);

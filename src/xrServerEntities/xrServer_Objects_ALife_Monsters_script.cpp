...
void profile_name_set_script(CSE_ALifeTraderAbstract* ta, LPCSTR str) { ta->set_character_profile(str); }
...
LPCSTR character_name_str_script(CSE_ALifeTraderAbstract* ta) { return ta->m_character_name_str.c_str(); }

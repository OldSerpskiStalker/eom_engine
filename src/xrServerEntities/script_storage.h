...
// AVO: allow LUA debug prints (i.e.: ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError, "CWeapon :
// cannot access class member Weapon_IsScopeAttached!");)

...
virtual void __stdcall on_render(
    CDUInterface* du, ISE_AbstractLEOwner* owner, bool bSelected, const Fmatrix& parent, int priority, bool strictB2F);
#endif
...
#define script_type_list save_type_list(CSE_ALifePHSkeletonObject)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(
        CSE_ALifeSpaceRestrictor, CSE_ALifeDynamicObject, CSE_Shape) u8 m_space_restrictor_type;
...
#define script_type_list save_type_list(CSE_ALifeObjectProjector)
    ...
    SERVER_ENTITY_DECLARE_BEGIN3(
        CSE_ALifeHelicopter, CSE_ALifeDynamicObjectVisual, CSE_Motion, CSE_PHSkeleton) shared_str engine_sound;
...
#define script_type_list save_type_list(CSE_ALifeTeamBaseZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeInventoryBox, CSE_ALifeDynamicObjectVisual) bool m_can_take;
bool m_closed;

...
void CScriptGameObject::set_force_anti_aim(bool force)
{
    ...
    if (!monster)
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "object is not CBaseMonster to call set_force_anti_aim");
        return;
    }
...
bool CScriptGameObject::get_force_anti_aim()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "object is not CBaseMonster to call get_force_anti_aim");
        return false;
    }
...
void CScriptGameObject::burer_set_force_gravi_attack(bool force)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "object is not CBurer to call burer_set_force_gravi_attack");
        return;
    }
...
void CScriptGameObject::poltergeist_set_actor_ignore(bool ignore)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "object is not Poltergeist to call poltergeist_set_actor_ignore");
        return;
    }
...
bool CScriptGameObject::poltergeist_get_actor_ignore()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "object is not Poltergeist to call poltergeist_get_actor_ignore");
        return false;
    }
...
int CScriptGameObject::get_visibility_state()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Bloodsucker : cannot access class member get_visibility_state!");
...
void CScriptGameObject::set_invisible(bool val)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Bloodsucker : cannot access class member set_invisible!");
        return;
    }
...
void CScriptGameObject::set_manual_invisibility(bool val)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Bloodsucker : cannot access class member set_manual_invisible!");
        return;
    }
...
void CScriptGameObject::set_enemy(CScriptGameObject* e)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Bloodsucker : cannot access class member set_enemy!");
        return;
    }
    CGameObject* game_object = &e->object();
    CEntityAlive* entity_alive = smart_cast<CEntityAlive*>(game_object);
...
void CScriptGameObject::set_vis_state(float val)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Bloodsucker : cannot access class member set_vis_state!");
        return;
    }
    if (val == 1)
    {
...
CScriptSoundInfo CScriptGameObject::GetSoundInfo()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member GetSoundInfo!");
    }
    return (ret_val);
}
...
CScriptMonsterHitInfo CScriptGameObject::GetMonsterHitInfo()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member GetMonsterHitInfo!");
    }
    return (ret_val);
}
...
bool CScriptGameObject::fake_death_fall_down()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CZombie : cannot access class member fake_death_fall_down!");
        return false;
    }

...
static bool trajectory_check_collision(float low, float high, Fvector const& position, Fvector const& velocity,
    Fvector const& gravity, CObject* const self_object, CObject* const ignored_object, Fvector& collide_position,
    collide::rq_results& temp_rq_results, Fvector box_size, xr_vector<trajectory_pick>* const out_trajectory_picks,
...
bool trajectory_intersects_geometry(float trajectory_time, Fvector const& trajectory_start,
    ...
    CObject* const self_object, CObject* const ignored_object, collide::rq_results& temp_rq_results,

...
void CScriptGameObject::IterateInventory(luabind::functor<bool> functor, luabind::object object)
{
    ...
    if (!inventory_owner)
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::IterateInventory non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::IterateInventoryBox(luabind::functor<bool> functor, luabind::object object)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::IterateInventoryBox non-CInventoryBox object !!!");
        return;
    }
...
void CScriptGameObject::MarkItemDropped(CScriptGameObject* item)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MarkItemDropped non-CInventoryOwner object !!!");
        return;
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MarkItemDropped non-CInventoryItem object !!!");
        return;
    }
...
bool CScriptGameObject::MarkedDropped(CScriptGameObject* item)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MarkedDropped non-CInventoryOwner object !!!");
        return (false);
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MarkedDropped non-CInventoryItem object !!!");
        return (false);
    }
...
void CScriptGameObject::UnloadMagazine()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::UnloadMagazine non-CWeaponMagazined object !!!");
        return;
    }
...
void CScriptGameObject::DropItem(CScriptGameObject* pItem)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::DropItem non-CInventoryOwner object !!!");
        return;
    }
...
int CScriptGameObject::GetGoodwill(CScriptGameObject* pToWho)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "GetGoodwill available only for InventoryOwner");
        return 0;
    }
...
void CScriptGameObject::SetGoodwill(int goodwill, CScriptGameObject* pWhoToSet)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetGoodwill available only for InventoryOwner");
        return;
    }
...
void CScriptGameObject::ForceSetGoodwill(int goodwill, CScriptGameObject* pWhoToSet)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "ForceSetGoodwill available only for InventoryOwner");
        return;
    }
...
void CScriptGameObject::ChangeGoodwill(int delta_goodwill, CScriptGameObject* pWhoToSet)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "ChangeGoodwill available only for InventoryOwner");
        return;
    }
...
void CScriptGameObject::SetRelation(ALife::ERelationType relation, CScriptGameObject* pWhoToSet)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetRelation available only for InventoryOwner");
        return;
    }
...
float CScriptGameObject::GetSympathy()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "GetSympathy available only for InventoryOwner");
        return 0.0f;
    }
...
void CScriptGameObject::SetSympathy(float sympathy)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetSympathy available only for InventoryOwner");
        return;
    }
...
int CScriptGameObject::GetCommunityGoodwill_obj(LPCSTR community)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "GetCommunityGoodwill available only for InventoryOwner");
        return 0;
    }
...
void CScriptGameObject::SetCommunityGoodwill_obj(LPCSTR community, int goodwill)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetCommunityGoodwill available only for InventoryOwner");
        return;
    }
    CHARACTER_COMMUNITY c;
    c.set(community);
...
LPCSTR CScriptGameObject::ProfileName()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "ProfileName available only for InventoryOwner");
        return NULL;
    }
...
LPCSTR CScriptGameObject::CharacterName()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CharacterName available only for InventoryOwner");
        return NULL;
    }
...
LPCSTR CScriptGameObject::CharacterIcon()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CharacterIconName available only for InventoryOwner");
        return NULL;
    }
...
int CScriptGameObject::CharacterRank()
{
    ...
    if (!monster)
    {
        ...
        {
            ai().script_engine().script_log(
                ScriptStorage::eLuaMessageTypeError, "CharacterRank available only for InventoryOwner and BaseMonster");
            return 0;
        }
...
void CScriptGameObject::SetCharacterRank(int char_rank)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetCharacterRank available only for InventoryOwner");
        return;
    }
...
void CScriptGameObject::ChangeCharacterRank(int char_rank)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "ChangeCharacterRank available only for InventoryOwner");
        return;
    }
...
int CScriptGameObject::CharacterReputation()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CharacterReputation available only for InventoryOwner");
        return 0;
    }
...
void CScriptGameObject::ChangeCharacterReputation(int char_rep)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "ChangeCharacterReputation available only for InventoryOwner");
        return;
    }
...
void CScriptGameObject::SetCharacterReputation(int char_rep)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetCharacterReputation available only for InventoryOwner");
        return;
    }
...
LPCSTR CScriptGameObject::CharacterCommunity()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CharacterCommunity available only for InventoryOwner");
        return NULL;
    }
...
void CScriptGameObject::SetCharacterCommunity(LPCSTR comm, int squad, int group)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetCharacterCommunity available only for InventoryOwner");
        return;
    }
...
LPCSTR CScriptGameObject::sound_voice_prefix() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "sound_voice_prefix available only for InventoryOwner");
        return NULL;
    }
...
void CScriptGameObject::add_restrictions(LPCSTR out, LPCSTR in)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CRestrictedObject : cannot access class member add_restrictions!");
        return;
    }
...
void CScriptGameObject::remove_restrictions(LPCSTR out, LPCSTR in)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CRestrictedObject : cannot access class member remove_restrictions!");
        return;
    }
...
LPCSTR CScriptGameObject::in_restrictions()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CRestrictedObject : cannot access class member in_restrictions!");
        return ("");
    }
...
LPCSTR CScriptGameObject::out_restrictions()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CRestrictedObject : cannot access class member out_restrictions!");
        return ("");
    }
...
bool CScriptGameObject::accessible_position(const Fvector& position)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CRestrictedObject : cannot access class member accessible!");
        return (false);
    }
...
void CScriptGameObject::enable_night_vision(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CTorch : cannot access class member enable_night_vision!");
        return;
    }
...
void CScriptGameObject::enable_torch(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CTorch : cannot access class member enable_torch!");
        return;
    }
    torch->Switch(value);
}
...
bool CScriptGameObject::torch_enabled() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CTorch : cannot access class member torch_enabled!");
        return (false);
    }
...
int CScriptGameObject::Weapon_GrenadeLauncher_Status()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeapon : cannot access class member Weapon_GrenadeLauncher_Status!");
        return (false);
    }
...
int CScriptGameObject::Weapon_Scope_Status()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeapon : cannot access class member Weapon_Scope_Status!");
        return (false);
    }
...
int CScriptGameObject::Weapon_Silencer_Status()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeapon : cannot access class member Weapon_Silencer_Status!");
        return (false);
    }
...
bool CScriptGameObject::Weapon_IsScopeAttached()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeapon : cannot access class member Weapon_IsScopeAttached!");
        return (false);
    }
...
bool CScriptGameObject::Weapon_IsSilencerAttached()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeapon : cannot access class member Weapon_IsSilencerAttached!");
        return (false);
    }
...
int CScriptGameObject::animation_slot() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CHudItem : cannot access class member animation_slot!");
        return (u32(-1));
    }
...
CScriptGameObject* CScriptGameObject::active_device() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member active_detector!");
        return (0);
    }
...
CScriptGameObject* CScriptGameObject::item_in_slot(u32 slot_id) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member item_in_slot!");
        return (0);
    }
...
u32 CScriptGameObject::active_slot()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member active_slot!");
        return (0);
    }
...
void CScriptGameObject::activate_slot(u32 slot_id)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member activate_slot!");
        return;
    }
...
void CScriptGameObject::enable_movement(bool enable)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CCustomMonster : cannot access class member movement_enabled!");
        return;
    }
...
bool CScriptGameObject::can_throw_grenades() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member can_throw_grenades!");
        return (false);
    }
...
u32 CScriptGameObject::throw_time_interval() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member throw_time_interval!");
        return (0);
    }
...
u32 CScriptGameObject::group_throw_time_interval() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member group_throw_time_interval!");
        return (0);
    }
...
void CScriptGameObject::aim_time(CScriptGameObject* weapon, u32 aim_time)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member aim_time!");
        return;
    }
...
void CScriptGameObject::special_danger_move(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member special_danger_move!");
        return;
    }
...
void CScriptGameObject::sniper_update_rate(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member sniper_update_rate!");
        return;
    }
...
void CScriptGameObject::sniper_fire_mode(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member sniper_fire_mode!");
        return;
    }
...
void CScriptGameObject::aim_bone_id(LPCSTR bone_id)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member aim_bone_id!");
        return;
    }
...
void CScriptGameObject::register_in_combat()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member register_in_combat!");
        return;
    }
...
void CScriptGameObject::unregister_in_combat()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member unregister_in_combat!");
        return;
    }
...
CCoverPoint const* CScriptGameObject::find_best_cover(Fvector position_to_cover_from)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member find_best_cover!");
        return (0);
    }
...
bool CScriptGameObject::suitable_smart_cover(CScriptGameObject* object)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker::suitable_smart_cover null smart cover specified!");
        return (false);
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member suitable_smart_cover!");
        return (false);
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : suitable_smart_cover: passed non-smart_cover object!");
        return (false);
    }
...
void CScriptGameObject::take_items_enabled(bool const value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member take_items_enabled!");
        return;
    }
...
void CScriptGameObject::SetPlayShHdRldSounds(bool val)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member SetPlayShHdRldSounds!");
        return;
    }
...
void CScriptGameObject::death_sound_enabled(bool const value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member death_sound_enabled!");
        return;
    }
...
void CScriptGameObject::Weapon_AddonAttach(CScriptGameObject* item)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeaponMagazined : cannot access class member Weapon_AddonAttach!");
        return;
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeaponMagazined : trying to attach non-CInventoryItem!");
        return;
    }
...
void CScriptGameObject::Weapon_AddonDetach(LPCSTR item_section)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CWeaponMagazined : cannot access class member Weapon_AddonDetach!");
        return;
    }
...
bool CScriptGameObject::InstallUpgrade(LPCSTR upgrade)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryItem : cannot access class member InstallUpgrade!");
        return false;
    }
...
bool CScriptGameObject::HasUpgrade(LPCSTR upgrade)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryItem : cannot access class member HasUpgrade!");
        return false;
    }
...
CScriptGameObject* CScriptGameObject::ItemOnBelt(u32 item_id) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member item_on_belt!");
        return (0);
    }
...
bool CScriptGameObject::IsOnBelt(CScriptGameObject* obj) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryItem : cannot access class member is_on_belt!");
        return (0);
    }
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member is_on_belt!");
        return (0);
    }
...
u32 CScriptGameObject::BeltSize() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member move_to_belt!");
        return (0);
    }
...
float CScriptGameObject::GetActorMaxWeight() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member GetActorMaxWeight!");
        return (false);
    }
...
void CScriptGameObject::SetActorMaxWeight(float max_weight)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member SetActorMaxWeight!");
        return;
    }
...
float CScriptGameObject::GetActorMaxWalkWeight() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member GetActorMaxWalkWeight!");
        return (false);
    }
...
void CScriptGameObject::SetActorMaxWalkWeight(float max_walk_weight)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member SetActorMaxWalkWeight!");
        return;
    }
...
float CScriptGameObject::GetAdditionalMaxWeight() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CCustomOutfit : cannot access class member GetAdditionalMaxWeight!");
        return (false);
    }
...
void CScriptGameObject::SetAdditionalMaxWeight(float add_max_weight)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CCustomOutfit : cannot access class member SetAdditionalMaxWeight!");
        return;
    }
...
float CScriptGameObject::GetTotalWeight() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member GetTotalWeight!");
        return (false);
    }
...
float CScriptGameObject::Weight() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CSciptEntity : cannot access class member Weight!");
        return (false);
    }
...
void CScriptGameObject::SetWeight(float w)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CSciptEntity : cannot access class member SetWeight!");
        return;
    }
...
float CScriptGameObject::GetActorJumpSpeed() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member GetActorJumpSpeed!");
        return (false);
    }
...
void CScriptGameObject::SetActorJumpSpeed(float jump_speed)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member SetActorJumpSpeed!");
        return;
    }
...
void CScriptGameObject::SetCharacterIcon(LPCSTR iconName)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "SetCharacterIcon available only for InventoryOwner");
        return;
    }

...
bool CScriptGameObject::use_smart_covers_only() const
{
    ...
    if (!stalker)
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member use_smart_covers_only!");
        return (false);
    }
...
bool CScriptGameObject::in_smart_cover() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member in_smart_cover_mode!");
        return ("");
    }
...
void CScriptGameObject::set_dest_smart_cover(LPCSTR cover_id)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member set_dest_smart_cover!");
        return;
    }
...
CCoverPoint const* CScriptGameObject::get_dest_smart_cover()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member get_dest_smart_cover!");
        return (0);
    }
...
void CScriptGameObject::set_dest_loophole(LPCSTR loophole_id)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member set_dest_loophole!");
        return;
    }
...
void CScriptGameObject::set_smart_cover_target(Fvector value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member set_smart_cover_target!");
        return;
    }
...
bool CScriptGameObject::in_loophole_fov(LPCSTR cover_id, LPCSTR loophole_id, Fvector object_position) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member object_in_loophole_fov!");
        return (false);
    }
...
bool CScriptGameObject::in_loophole_range(LPCSTR cover_id, LPCSTR loophole_id, Fvector object_position) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member object_in_loophole_range!");
        return (false);
    }
...
float const CScriptGameObject::idle_min_time() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member idle_min_time!");
        return (flt_max);
    }
...
float const CScriptGameObject::idle_max_time() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member idle_max_time!");
        return (flt_max);
    }
...
float const CScriptGameObject::lookout_min_time() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member lookout_min_time!");
        return (flt_max);
    }
...
float const CScriptGameObject::lookout_max_time() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member lookout_max_time!");
        return (flt_max);
    }
...
bool CScriptGameObject::movement_target_reached()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member movement_target_reached!");
        return (false);
    }

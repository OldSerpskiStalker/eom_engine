...
class action_base : public CStalkerActionCombatBase, private boost::noncopyable
{
private:
...
class non_animated_change_loophole : public action_base, private debug::make_final<non_animated_change_loophole>
{
private:
    typedef action_base inherited;

...
void CActor::g_SetAnimation(u32 mstate_rl)
{
    ...
    // STorsoWpn* __TW = &ST->m_torso[4]; //Alundaio: Animation Set knife/grenade running animation without weapon by
    // XEM #100
    ...
    if ((Level().CurrentControlEntity() == this) && g_ShowAnimationInfo)
    {
        ...
        /*
           ...
           %3.2f]",VPUSH(m_PhysicMovementControl->GetVelocity())); UI().Font().pFontStat->OutNext	("vertex ID

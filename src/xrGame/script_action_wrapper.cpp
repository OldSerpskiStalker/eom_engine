...
//luabind::call_member<_edge_value_type>(const_cast<CScriptActionWrapper*>(this),"weight",condition0,condition1); 	if
//(_weight < min_weight()) { 		ai().script_engine().script_log	(eLuaMessageTypeError,"Weight is less than effect count!
//It is corrected from %d to %d",_weight,min_weight()); 		_weight							= min_weight();
//	}
//	return								(_weight);
// }
//

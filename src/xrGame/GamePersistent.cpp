...
//	static	void	ode_free	(void *ptr, size_t size)					{ return xr_free(ptr); } #else //
// DEBUG_MEMORY_MANAGER 	static	void *	ode_alloc	(size_t size)								{ return
//xr_malloc(size);			} 	static	void *	ode_realloc	(void *ptr, size_t oldsize, size_t newsize)	{ return
//xr_realloc(ptr,newsize);	}

...
{
    module(
        L)[class_<CALifeMonsterPatrolPathManager>("CALifeMonsterPatrolPathManager")
               .def("path", (void(CALifeMonsterPatrolPathManager::*)(LPCSTR))(&CALifeMonsterPatrolPathManager::path))
               .def("start_type",
                   (void(CALifeMonsterPatrolPathManager::*)(const EPatrolStartType&))(
                       &CALifeMonsterPatrolPathManager::start_type))
               .def("start_type",
                   (const EPatrolStartType& (CALifeMonsterPatrolPathManager::*)() const)(
                       &CALifeMonsterPatrolPathManager::start_type))
               .def("route_type",
                   (void(CALifeMonsterPatrolPathManager::*)(const EPatrolRouteType&))(
                       &CALifeMonsterPatrolPathManager::route_type))
               .def("route_type",
                   (const EPatrolRouteType& (CALifeMonsterPatrolPathManager::*)() const)(
                       &CALifeMonsterPatrolPathManager::route_type))
               ...
               .def("use_randomness",
                   (void(CALifeMonsterPatrolPathManager::*)(const bool&))(

...
void CServerList::FillUpDetailedServerInfo()
{
    ...
    //			{
    //				pItemAdv					=
    //m_list[LST_PLAYERS].AddTextItem(CStringTable().translate("mp_spectator").c_str()); 				spect = true;
    //			}
...
bool CServerList::sort_by_Players(int p1, int p2)
{
    ...
    // return (g_bSort_Ascending) ? (info1.m_ServerNumPlayers < info2.m_ServerNumPlayers) : (info1.m_ServerNumPlayers >

...
private:
    ...
    GAMESPY_FN_VAR_DECL(
        SBError, ServerBrowserUpdateA, (void* sb, SBBool async, SBBool disconnectOnComplete, const char* serverFilter));
    ...
    GAMESPY_FN_VAR_DECL(
        SBError, ServerBrowserAuxUpdateServer, (void* sb, void* server, SBBool async, SBBool fullUpdate));
    GAMESPY_FN_VAR_DECL(SBError, ServerBrowserAuxUpdateIPA,
        (void* sb, const char* ip, unsigned short port, SBBool viaMaster, SBBool async, SBBool fullUpdate));

    GAMESPY_FN_VAR_DECL(const char*, SBServerGetPlayerStringValueA,
    ...
    GAMESPY_FN_VAR_DECL(
        double, SBServerGetPlayerFloatValueA, (void* server, int playernum, const char* key, double fdefault));

    GAMESPY_FN_VAR_DECL(
        const char*, SBServerGetTeamStringValueA, (void* server, int teamnum, const char* key, const char* sdefault));
    GAMESPY_FN_VAR_DECL(int, SBServerGetTeamIntValueA, (void* server, int teamnum, const char* key, int idefault));
    GAMESPY_FN_VAR_DECL(
        double, SBServerGetTeamFloatValueA, (void* server, int teamnum, const char* key, double fdefault));
    ...
    GAMESPY_FN_VAR_DECL(
        SBBool, SBServerGetConnectionInfo, (void* sb, void* server, int PortToConnectTo, char* ipstring));
    GAMESPY_FN_VAR_DECL(SBBool, SBServerDirectConnect, (void* server));
    GAMESPY_FN_VAR_DECL(
        void, ServerBrowserSortA, (void* sb, SBBool ascending, const char* sortkey, SBCompareMode comparemode));

...
TEMPLATE_SPECIALIZATION
IC void CBucketList::set_min_bucket_value(const _dist_type min_bucket_value) { m_min_bucket_value = min_bucket_value; }

TEMPLATE_SPECIALIZATION
IC void CBucketList::set_max_bucket_value(const _dist_type max_bucket_value) { m_max_bucket_value = max_bucket_value; }

...
{
public:
    explicit event_conditions_collection(game_state_accumulator* pstate_accum, event_action_delegate_t ea_delegate);
...
protected:
    ...
    void add_event(event_condition_t* root_condition, u32 const max_rise_count, u32 const game_id_mask,
    ...
    event_condition_t* add_kill_condition_dist(
        u32 kill_counts, u16 weapon_id, u16 kill_type, u16 special_kill_type, u32 time_period = u32(-1));

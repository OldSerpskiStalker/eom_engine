...
void CWeaponRevolver::net_Destroy() { inherited::net_Destroy(); }
...
void CWeaponRevolver::OnH_B_Chield() { inherited::OnH_B_Chield(); }
...
void CWeaponRevolver::switch2_Reload() { inherited::switch2_Reload(); }

void CWeaponRevolver::OnAnimationEnd(u32 state) { inherited::OnAnimationEnd(state); }

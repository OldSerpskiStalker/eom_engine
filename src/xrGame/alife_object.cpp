...
#pragma warning(pop)
    ...
    // No need to spawn ammo, this will automatically spawn 1 box for weapon and if ammo_type is specficied it will
    // spawn that type count is used only for ammo boxes (ie wpn_pm = 3) will spawn 3 boxes, not 3 wpn_pm Usage: to
    // create random weapon loadouts

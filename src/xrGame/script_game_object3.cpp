    ...
    float min_enemy_distance, float max_enemy_distance)
{
    ...
    if (!stalker)
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member best_cover!");
        return (0);
    }
...
const xr_vector<MemorySpace::CVisibleObject>& CScriptGameObject::memory_visible_objects() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member memory_visible_objects!");
        NODEFAULT;
    }
...
const xr_vector<MemorySpace::CSoundObject>& CScriptGameObject::memory_sound_objects() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member memory_sound_objects!");
        NODEFAULT;
    }
...
const xr_vector<MemorySpace::CHitObject>& CScriptGameObject::memory_hit_objects() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member memory_hit_objects!");
        NODEFAULT;
    }
...
void CScriptGameObject::ChangeTeam(u8 team, u8 squad, u8 group)
{
    ...
    if (!custom_monster)
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CCustomMonster: cannot access class member ChangeTeam!");
    else
...
CScriptGameObject* CScriptGameObject::GetEnemy() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member GetEnemy!");
        return (0);
    }
}
...
CScriptGameObject* CScriptGameObject::GetCorpse() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member GetCorpse!");
        return (0);
    }
}
...
bool CScriptGameObject::CheckTypeVisibility(const char* section_name)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member CheckTypeVisibility!");
        return (false);
    }
}
...
CScriptGameObject* CScriptGameObject::GetCurrentWeapon() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member GetCurrentWeapon!");
        return (0);
    }
...
void CScriptGameObject::deadbody_closed(bool status)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member deadbody_closed!");
        return;
    }
...
void CScriptGameObject::can_select_weapon(bool status)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member can_select_weapon!");
        return;
    }
...
void CScriptGameObject::deadbody_can_take(bool status)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member deadbody_can_take!");
        return;
    }
...
CScriptGameObject* CScriptGameObject::GetCurrentOutfit() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member GetCurrentOutfit!");
        return (0);
    }
...
CScriptGameObject* CScriptGameObject::GetFood() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member GetFood!");
        return (0);
    }
...
LPCSTR CScriptGameObject::GetPatrolPathName()
{
    ...
    if (!stalker)
    {
        ...
        {
            ai().script_engine().script_log(
                ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member GetPatrolPathName!");
            return ("");
        }
        else
...
void CScriptGameObject::add_animation(LPCSTR animation, bool hand_usage, bool use_movement_controller)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member add_animation!");
        return;
    }
...
void CScriptGameObject::clear_animations()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CGameObject : cannot access class member clear_animations!");
        return;
    }
    ...
    const PatrolPathManager::EPatrolRouteType patrol_route_type, bool random)
{
    ...
    if (!stalker)
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member movement!");
    else
...
void CScriptGameObject::set_dest_level_vertex_id(u32 level_vertex_id)
{
    ...
    if (!stalker)
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member set_dest_level_vertex_id!");
    else
    {
...
void CScriptGameObject::set_dest_game_vertex_id(GameGraph::_GRAPH_ID game_vertex_id)
{
    ...
    if (!stalker)
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member set_dest_game_vertex_id!");
    else
    {
...
CHARACTER_RANK_VALUE CScriptGameObject::GetRank()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member GetRank!");
...
MonsterSpace::EBodyState CScriptGameObject::body_state() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member body_state!");
...
MonsterSpace::EMovementType CScriptGameObject::movement_type() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member movement_type!");
...
MonsterSpace::EMovementType CScriptGameObject::target_movement_type() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member target_movement_type!");
        return (MonsterSpace::eMovementTypeStand);
    }
...
MonsterSpace::EMentalState CScriptGameObject::mental_state() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member mental_state!");
...
MovementManager::EPathType CScriptGameObject::path_type() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member path_type!");
...
DetailPathManager::EDetailPathType CScriptGameObject::detail_path_type() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CAI_Stalker : cannot access class member detail_path_type!");
...
void CScriptGameObject::set_sight(SightManager::ESightType sight_type, Fvector* vector3d, u32 dwLookOverDelay)
{
    ...
    if (!stalker)
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CSightManager : cannot access class member set_sight!");
    else
    {
...
u32 CScriptGameObject::GetInventoryObjectCount() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member obj_count!");
        return (0);
    }
}
...
CScriptGameObject* CScriptGameObject::GetActiveItem()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member activge_item!");
        return (0);
    }
}
...
CScriptGameObject* CScriptGameObject::GetObjectByName(LPCSTR caObjectName) const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member object!");
        return (0);
    }
}
...
bool CScriptGameObject::weapon_strapped() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member weapon_strapped!");
        return (false);
    }
...
bool CScriptGameObject::weapon_unstrapped() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member weapon_unstrapped!");
        return (false);
    }
...
bool CScriptGameObject::path_completed() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member path_completed!");
        return (false);
    }
...
Fvector CScriptGameObject::head_orientation() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot access class member head_orientation!");
...
void CScriptGameObject::jump(const Fvector& position, float factor)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject : cannot process jump for not a monster!");
        return;
    }
...
void CScriptGameObject::sell_condition(CScriptIniFile* ini_file, LPCSTR section)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member sell_condition!");
        return;
    }
...
void CScriptGameObject::buy_condition(CScriptIniFile* ini_file, LPCSTR section)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member buy_condition!");
        return;
    }
...
void CScriptGameObject::show_condition(CScriptIniFile* ini_file, LPCSTR section)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member show_condition!");
        return;
    }
...
void CScriptGameObject::buy_item_exponent(float factor)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member buy_item_exponent!");
        return;
    }
...
void CScriptGameObject::sell_item_exponent(float factor)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CInventoryOwner : cannot access class member sell_item_exponent!");
        return;
    }
...
LPCSTR CScriptGameObject::sound_prefix() const
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CCustomMonster : cannot access class member sound_prefix!");
        return (0);
    }
...
void CScriptGameObject::SetSpatialType(u32 sptype) { object().spatial.type = sptype; }

u32 CScriptGameObject::GetSpatialType() { return object().spatial.type; }

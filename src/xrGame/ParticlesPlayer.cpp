...
void CParticlesPlayer::UpdateParticles()
{
    ...
    for (BoneInfoVecIt b_it = m_Bones.begin(); b_it != m_Bones.end(); b_it++)
    {
        ...
        const auto RI = std::remove_if(b_info.particles.begin(), b_info.particles.end(),
...
void CParticlesPlayer::MakeXFORM(
    CObject* pObject, u16 bone_id, const Fvector& dir, const Fvector& offset, Fmatrix& result)
{

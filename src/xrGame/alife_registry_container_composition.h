...
// äëÿ âñåõ ïåðñîíàæåé, òå ïîðöèè èíôîðìàöèè, êîòîðûå îíè ïîìíÿò
...
#define registry_type_list save_registry_type_list(CInfoPortionRegistry)
    ...
    // äëÿ âñåõ ïåðñîíàæåé, îòíîøåíèÿ ñ äðóãèìè ïåðñîíàæàìè
...
#define registry_type_list save_registry_type_list(CRelationRegistry)
    ...
    ////äëÿ àêòåðîâ, ñïèñîê ïåðñîíàæåé ñ êîòîðûìè áûëè ðàçãîâîðû
    ...
    //
    ////ñïèñîê ñòàòåé ýíöèêëîïåäèè, êîòîðûå çíàåò àêòåð
    ...
    // ñïèñîê íîâîñòåé ïîëó÷åííûõ àêòåðîì, ñîñòîèò èç íîâîñòåé ñèìóëÿöèè è ñþæåòíûõ (ñêðèïòîâàíûõ) íîâîñòåé
...
#define registry_type_list save_registry_type_list(CGameNewsRegistry)
    ...
    // ñïèñîê îïèñàíèé ïåðñîíàæåé, êîòîðûå óæå çàäåéñòâîâàíû â èãðå

...
TEMPLATE_SPECIALIZATION
IC void CHashFixedVertexManager::add_opened(CGraphVertex& vertex) { vertex.opened() = 1; }

TEMPLATE_SPECIALIZATION
IC void CHashFixedVertexManager::add_closed(CGraphVertex& vertex) { vertex.opened() = 0; }
...
TEMPLATE_SPECIALIZATION
IC bool CHashFixedVertexManager::is_opened(const CGraphVertex& vertex) const { return (vertex.opened()); }
...
TEMPLATE_SPECIALIZATION
IC bool CHashFixedVertexManager::is_closed(const CGraphVertex& vertex) const { return (!is_opened(vertex)); }

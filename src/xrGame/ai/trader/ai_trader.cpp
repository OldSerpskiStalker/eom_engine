...
BOOL CAI_Trader::net_Spawn(CSE_Abstract* DC)
{
    ...
    // ïðîñïàâíèòü PDA ó InventoryOwner
...
// ïðîâåðÿåò ñïèñîê àðòåôàêòîâ â çàêàçàõ
u32 CAI_Trader::ArtefactPrice(CArtefact* pArtefact) { return pArtefact->Cost(); }

// ïðîäàæà àðòåôàêòà, ñ ïîñëåäóåùèì èçìåíåíèåì ñïèñêà çàêàçîâ (true - åñëè àðòåôàêò áûë â ñïèñêå)

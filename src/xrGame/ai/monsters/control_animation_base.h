...
protected:
    REPLACED_ANIM m_tReplacedAnims; // àíèìàöèè ïîäìåíû

    // ñîõðàí¸ííûå àíèìàöèè
    EMotionAnim prev_motion;

    // èñïðàâëåíèÿ ñîñîÿíèÿ 'áåãà íà ìåñòå'
    TTime time_start_stand;

    // ðàáîòà ñ àíèìàöèÿìè àòàêè
    TTime aa_time_last_attack; // âðåìÿ ïîñëåäíåãî íàíåñåíèÿ õèòà

    // -------------------------------------------------------------------------
    u32 spec_params; // äîïîëíèòåëüíûå ïàðàìåòðû
    ...
    {
        bool active;
        bool enable_braking; // íå èñïîëüçîâàòü ïðè òîðìîæåíèè
    ...
    MOTION_ITEM_MAP m_tMotions; // êàðòà ñîîòâåòñâèé EAction ê SMotionItem
    TRANSITION_ANIM_VECTOR m_tTransitions; // âåêòîð ïåðåõîäîâ èç îäíîé àíèìàöèè â äðóãóþ
...
public:
    ...
    // ñîçäàíèå êàðòû àíèìàöèé (âûïîëíÿòü íà Monster::Load)
    ...
    // äîáàâèòü àíèìàöèþ ïåðåõîäà (A - Animation, S - Position)

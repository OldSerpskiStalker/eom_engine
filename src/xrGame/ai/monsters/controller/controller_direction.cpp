...
void CControllerDirection::assign_bones()
{
    ...
    {
        // íåëüçÿ ñòàâèòü êîëáåêè, åñëè ñîçäàí ôèç øåë - ó íåãî ñòîÿò ñâîè êîëáåêè!!!
...
void CControllerDirection::head_look_point(const Fvector& look_point)
{
    ...
    // óñòàíîâèòü ïàðàìåòðû âðàùåíèÿ ïî heading
    float cur_yaw = m_man->direction().get_heading_current();
    float dy = _abs(angle_normalize_signed(dir_yaw - cur_yaw)); // äåëüòà, íà êîòîðóþ íóæíî ïîâîðà÷èâàòüñÿ
    ...
    //// óñòàíîâèòü ïàðàìåòðû âðàùåíèÿ ïî pitch (áîëåå óïðîùåíàÿ ñõåìà, áåç ðàñ÷åòà ñêîðîñòè âðàùåíèÿ)

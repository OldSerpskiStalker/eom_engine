...
class CController : public CBaseMonster, public CControlledActor
{
    ...
    ref_sound control_start_sound; // çâóê, êîòîðûé èãðàåòñÿ â ãîëîâå ó àêòåðà
    ref_sound control_hit_sound; // çâóê, êîòîðûé èãðàåòñÿ â ãîëîâå ó àêòåðà
...
public:
    ...
    void OnFreedFromControl(const CEntity*); // åñëè ìîíñòð ñàì ñåáÿ îñâîáîäèë (destroyed || die)

...
typedef struct tagSoundElement
{
    ...
    Fvector position; // ïîçèöèÿ çâóêà, íå îáúåêòà, èçäàâøåãî çâóê
    float power;
    TTime time; // âðåìÿ îáíàðóæåíèÿ çâóêà

    int value; // îöåíî÷íîå çíà÷åíèå äàííîãî çâóêà
...
{
    TTime time_memory; // âðåìÿ õðàíåíèÿ çâóêîâ
...
public:
    ...
    void GetSound(SoundElem& s, bool& bDangerous); // âîçâðàùàåò ñàìûé îïàñíûé çâóê
    SoundElem& GetSound();

...
class CControlPathBuilderBase : public CControl_ComBase
{
    ...
    u32 m_time; // âðåìÿ ïåðåñòðîåíèÿ ïóòè
    u32 m_last_time_target_set;
    float m_distance_to_path_end;
    bool m_failed;
    u32 m_last_time_dir_set;

    bool m_target_actual; // óñòàíàâëèâàåìûé òàðãåò ñîîòâåòñòâóåò ïðåäûäóùåìó
    ...
    // ñîñòîÿíèå, â êîòîðîì path_builder ðàáîòàåò íåçàâèñèìî

    ...
    for (u32 i = 0; i < objects.size(); i++)
    {
        ...
        case TS_Raise:
            if (cur_obj->check_height())
                cur_obj->prepare_keep(); // íà÷àòü óäåðæàíèå ïðåäìåòà
            break;
        case TS_Keep:

...
// ñïåöèàëüíûå ïàðàìåòðû àíèìàöèé (animation spec params)
...
#define AA_FLAG_ATTACK_RAT (1 << 0) // àòòàêà êðûñ?
#define AA_FLAG_FIRE_ANYWAY (1 << 1) // òðàññèðîâêà íå íóæíà
...
struct SAnimItem
{
    ...
    int spec_id; // (-1) - any,  (0 - ...) - èäåíòèôèêàòîð 3
    u8 count; // êîëè÷åñòâî àíèìàöèé : "idle_0", "idle_1", "idle_2"
...
// ïîäìåíà àíèìàöèé (åñëè *flag == true, òî íåîáõîäèìî çàìåíèòü àíèìàöèþ)
...
// Îïðåäåëåíèå âðåìåíè àòòàêè ïî àíèìàöèè
typedef struct
{
    EMotionAnim anim; // ïàðàìåòðû êîíêðåòíîé àíèìàöèè
    u32 anim_i3;

    TTime time_from; // äèàïàçîí âðåìåíè êîãäà ìîæíî íàíîñèòü hit (îò)
    TTime time_to; // äèàïàçîí âðåìåíè êîãäà ìîæíî íàíîñèòü hit (äî)

    Fvector trace_from; // íàïðàâëåíèå òðàññèðîâêè (îòíîñèòåëüíî öåíòðà)
    Fvector trace_to;

    u32 flags; // ñïåöèàëüíûå ôëàãè

    float damage; // óðîí ïðè äàííîé àòàêå
    Fvector hit_dir; // óãîë íàïðàâëåíèÿ ïðèëîæåíèÿ ñèëû ê îáúåêòó

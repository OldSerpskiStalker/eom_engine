...
void CTelekineticObject::raise_update()
{
    if (check_height() || check_raise_time_out())
        prepare_keep(); // íà÷àòü óäåðæàíèå ïðåäìåòà
...
{
    // ïðîâåðèòü âðåìÿ ïîñëåäíåãî îáíîâëåíèÿ
    ...
    // óñòàíîâèòü dir â ñîîòâåòñòâèå ñ òåêóùåé âûñîòîé
    Fvector dir;
    ...
    // óñòàíîâèòü âðåìÿ ïîñëåäíåãî îáíîâëåíèÿ
...
void CTelekineticObject::release()
{
    ...
    if (OnServer())
    {
        // ïðèëîæèòü íåáîëüøóþ ñèëó äëÿ òîãî, ÷òîáû îáúåêò íà÷àë ïàäàòü

...
void CPseudoGigant::Load(LPCSTR section)
{
    ...
    // anim().AddAnim(eAnimStandIdle,		"stand_idle_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimStandTurnLeft,	"stand_turn_ls_",		-1, &velocity_turn,
    // PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimStandTurnRight,
    // "stand_turn_rs_",		-1, &velocity_turn,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r"); anim().AddAnim(eAnimLieIdle,		"stand_sleep_",			-1, &velocity_none,		PS_LIE,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimSitIdle,		"sit_idle_",
    // -1, &velocity_none,		PS_SIT,		"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimSleep,			"stand_sleep_",			-1, &velocity_none,		PS_LIE,		"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimWalkFwd,		"stand_walk_fwd_",		-1, &velocity_walk,
    // PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimWalkDamaged,
    // "stand_walk_fwd_dmg_",	-1, &velocity_walk_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r");
    // anim().AddAnim(eAnimRun,			"stand_run_fwd_",		-1,	&velocity_run,		PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimRunDamaged,		"stand_run_dmg_",		-1, &velocity_run_dmg,
    // PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimEat,
    // "stand_eat_",			-1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r"); anim().AddAnim(eAnimAttack,			"stand_attack_",		-1, &velocity_turn,		PS_STAND,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimLookAround,		"stand_idle_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    // anim().AddAnim(eAnimSteal,			"stand_steal_",			-1, &velocity_steal,	PS_STAND,	"fx_stand_f", "fx_stand_b",
    // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimDie,			"stand_idle_",			-1, &velocity_none,
    // PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimStandLieDown,
    // "stand_lie_down_",		-1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
    // "fx_stand_r"); anim().AddAnim(eAnimLieToSleep,		"lie_to_sleep_",		-1, &velocity_none,		PS_LIE,
    // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimThreaten,		"stand_kick_",
    // -1, &velocity_none,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
...
void CPseudoGigant::event_on_step()
{
    ...
    if (pActor)
    {
        ...
        if (dist_to_actor < max_dist)
            Actor()->Cameras().AddCamEffector(xr_new<CPseudogigantStepEffector>(step_effector.time,
                step_effector.amplitude, step_effector.period_number, (max_dist - dist_to_actor) / (1.2f * max_dist)));
    }
    //////////////////////////////////
}

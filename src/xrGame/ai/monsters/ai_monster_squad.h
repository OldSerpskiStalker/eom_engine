...
{
    ESquadCommandType type; // òèï êîìàíäû
...
private:
    ...
    // êàðòà öåëåé ÷ëåíîâ ãðóïïû (îáíîâëÿåòñÿ ñî ñòîðîíû îáúåêòà)
    MEMBER_GOAL_MAP m_goals;

    // êàðòà êîììàíä ÷ëåíîâ ãðóïïû (îáíîâëÿåòñÿ ñî ñòîðîíû squad manager)

...
{
    module(
        L)[class_<CStalkerPlanner>("stalker_ids")
               .enum_("properties")[luabind::value("property_alive", StalkerDecisionSpace::eWorldPropertyAlive),
                   ...
                   luabind::value(
                       "property_enemy_critically_wounded", StalkerDecisionSpace::eWorldPropertyEnemyCriticallyWounded),
               ...
               .enum_("action")[luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead),
                   ...
                   luabind::value(
                       "action_communicate_with_customer", StalkerDecisionSpace::eWorldOperatorCommunicateWithCustomer),

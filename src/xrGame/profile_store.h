...
class profile_store : public ISheduled, private boost::noncopyable
{
public:
...
private:
    ...
    queued_async_method<profile_store, load_prof_params_t, store_operation_cb, &profile_store::load_current_profile_raw,

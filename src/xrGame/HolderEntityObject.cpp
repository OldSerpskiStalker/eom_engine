...
CHolderEntityObject::~CHolderEntityObject() { xr_delete(camera); }

void CHolderEntityObject::SetBoneCallbacks() { m_pPhysicsShell->EnabledCallbacks(FALSE); }

void CHolderEntityObject::ResetBoneCallbacks() { m_pPhysicsShell->EnabledCallbacks(TRUE); }
...
void CHolderEntityObject::renderable_Render() { inheritedPH::renderable_Render(); }
...
void CHolderEntityObject::SetParam(int id, Fvector2 val) { inheritedHolder::SetParam(id, val); }

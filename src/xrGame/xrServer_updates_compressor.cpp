...
void server_updates_compressor::flush_accumulative_buffer()
{
        ...
        (g_sv_traffic_optimization_level & eto_lzo_compression))
    {
        ...
        else
        {
            ...
            lzo_compress_dict(m_acc_buff.B.data, m_acc_buff.B.count, m_compress_buf.B.data,
                (lzo_uint*)&m_compress_buf.B.count, m_lzo_working_memory, m_lzo_dictionary.data, m_lzo_dictionary.size);
        }

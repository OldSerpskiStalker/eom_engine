...
float4 main ( p_filter I ) : SV_Target
{
	// sample
	float4 	accum0;
		accum0.x =	sample((float2)I.Tex0);
		accum0.y = 	sample((float2)I.Tex1);
		accum0.z = 	sample((float2)I.Tex2);
		accum0.w =	sample((float2)I.Tex3);
	float4 	accum1;
		accum1.x =	sample((float2)I.Tex4);
		accum1.y = 	sample((float2)I.Tex5);
		accum1.z = 	sample((float2)I.Tex6);
		accum1.w =	sample((float2)I.Tex7);
	float4 	accum2;
	...
	float  	scale_prev	= s_tonemap.Sample( smp_nofilter, (float2)I.Tex0 ).x;

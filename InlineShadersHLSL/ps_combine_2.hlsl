...
#include "Headers\dof_weather.hlsl"
#include "Headers\fog.hlsl"
// Check Screen Space Shaders modules
#include "ScreenSpaceAddon\screenspace_fog.hlsl"
#include "ScreenSpaceAddon\screenspace_indirect_light.hlsl"

#include "Headers\tonemapping.hlsl"
...
c2_out main( v2p_aa_AA I )
{
	...
	gbuffer_data gbd = gbuffer_load_data(I.Tex0, (float2)I.HPos, 0 );
